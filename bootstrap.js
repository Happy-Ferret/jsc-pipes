...
var core = {
	addon: {
		...
		path: {
			name: 'jsc-pipes',
			content: 'chrome://jsc-pipes/content/',
			modules: 'chrome://jsc-pipes/content/modules/',
			pages: 'chrome://jsc-pipes/content/resources/pages/',
			scripts: 'chrome://jsc-pipes/content/resources/scripts/',
			images: 'chrome://jsc-pipes/content/resources/images/'
		},
		prefbranch: 'extensions.jsc-pipes@jetpack.',
		prefs: {},
...
// start - PipesWorkerMainThreadFuncs
var PipesWorkerMainThreadFuncs = {
};
// end - PipesWorkerMainThreadFuncs
...
function startup(aData, aReason) {
	...
	promise_initPipeWorker.then(
		...
		genericReject.bind(null, 'promise_initPipeWorker', 0)
	).catch(genericCatch.bind(null, 'promise_initPipeWorker', 0));
...
function shutdown(aData, aReason) {
	...
	// destroy workers
	if (bootstrap.PipeWorker && PipeWorker.launchTimeStamp) {
		var promise_requestTerm = PipeWorker.post('prepTerm', []);
